...
On that day of reckoning… a joke was made that our co-op should be named “For the Horde”… a colloquial phrase where one sacrifices themselves for the group in order to move the group to better days (and more beer).
