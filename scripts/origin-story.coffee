...
module.exports = (robot) ->
  ORIGIN_STORY = [
    "Born on Tuesday, Feb 3, 2015 to single parent Justin Cardinal, I came into this world already knowing how to share excellent gifs and weather results with remarkable precision.",
    "As I matured under the tutelage of Jake Good, I began to shoulder more responsibility within the Horde. Welcoming new members and sharing the Code of Conduct became part of my normal daily activities.",
    ...
    "story by my friend, @experimatt"
    ]

  robot.respond /origin story/i, (msg) ->
    msg.send line for line in ORIGIN_STORY
